    ...
    <div className="max-w-2xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
      ...
      <div className="p-6 bg-gray-50">
          ...
          <div className="space-y-2">
            {items.map((item, index) => (
              <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <div className="font-medium">PKR {(item.price * item.quantity).toFixed(2)}</div>
              </div>
            ))}
        ...
        <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
          ...
          {paymentMethod !== 'cash_on_delivery' ? (
            <div className="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
              ...
              <p className="mb-2">{paymentInstructions[paymentMethod as keyof typeof paymentInstructions]}</p>
              <p>
                <span className="font-medium">Important:</span> Please include your order number{' '}
                <span className="font-bold">{orderNumber}</span> in the payment reference.
              </p>
            </div>
          ) : (
            <p className="text-green-600 font-medium">✓ You will pay when your order is delivered.</p>
          )}
        </div>
        ...
        <div className="bg-white rounded-lg p-6 mb-6 shadow-sm">
          ...
          <p className="mb-2">
            You will receive a tracking number via email once your order ships. You can also track your order status by visiting our website.
          </p>
          <p>
            For any questions about your order, please contact us with your order number:{' '}
        ...
        <div className="bg-gray-100 rounded-lg p-6">
          ...
          <div className="text-sm text-gray-700 space-y-1">
            <p><span className="font-medium">Customer Service:</span> Available 9 AM - 8 PM (Monday to Saturday)</p>
            <p><span className="font-medium">WhatsApp:</span> +92 304 1146524</p>
            <p><span className="font-medium">Email:</span> support@sufishine.com</p>
          </div>
        </div>
      </div>
      ...
      <div className="text-center p-6 text-gray-600">
        ...
        <p className="text-sm mt-1">Follow us on social media for beauty tips and product updates</p>
        <p className="text-xs mt-2">This is an automated message, please do not reply to this email.</p>
      </div>
    </div>
  );
};
