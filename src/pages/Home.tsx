  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  asChild
                  size="lg"
                  className="btn-spiritual text-lg px-8 py-6"
                >
                  <Link to="/shop">
                    Shop Now
            ...
            <div className="relative animate-float">
              ...
              <img
                ...
                className="relative rounded-3xl shadow-2xl w-full h-auto object-cover hover-glow"
              />
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="overflow-hidden hover-glow border-0 shadow-xl">
              <div className="grid grid-cols-1 md:grid-cols-2">
                {/* Product Image */}
                <div className="relative bg-gradient-to-br from-muted/30 to-muted/50 p-8 flex items-center justify-center">
                  <img
                    src={productImage}
      ...
      <section className="py-16 bg-muted/30 spiritual-pattern">
        <div className="container px-4">
          <div className="text-center mb-12 animate-fade-in">
            <h2 className="text-3xl font-bold mb-4">Why Choose SUFI SHINE?</h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="max-w-2xl mx-auto space-y-6 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg text-foreground bg-background/10 backdrop-blur border border-white/20 placeholder:text-white/70"
              />
              <Button className="btn-gold px-8 py-3">Subscribe</Button>
            </div>
          </div>
        </div>
      </section>
